...
# Canonical normalized unit contract for each core field.
# Nutrient units are aligned to USDA nutrient.csv definitions.
CORE_FIELD_UNITS: dict[str, str | None] = {
    ...
    "folate_vitamin_b9": "mcg",
    "vitamin_c_ascorbic_acid": "mg",
    "vitamin_d_calciferol": "mcg",
    "vitamin_e_tocopherol": "mg",
    "vitamin_k_phylloquinone_and_menaquinone": "mcg",
    "calcium": "mg",
    "copper": "mg",
    "iron": "mg",
    "manganese": "mg",
